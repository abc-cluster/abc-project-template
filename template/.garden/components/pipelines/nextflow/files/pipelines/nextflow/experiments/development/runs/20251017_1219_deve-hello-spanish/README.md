# Experiment: 20251017_1219_deve-hello-spanish

## Quick Info

- **Type**: development
- **Scenario**: local-local
- **Created**: 2025-10-17 12:19:55
- **Researcher**: abhi
- **Status**: planned

## Purpose

Testing Spanish greeting
...
just status 20251017_1219_deve-hello-spanish

# Fetch Tower metadata
just fetch-tower 20251017_1219_deve-hello-spanish

# Sync results
just sync-results 20251017_1219_deve-hello-spanish

# View in database
just query "SELECT * FROM experiments WHERE id='20251017_1219_deve-hello-spanish'"
```
