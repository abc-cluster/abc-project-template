# Investigation: 20251017_1151_deve-test-workflow
...
Testing the complete investigation lifecycle
...
# View in database
just query "SELECT * FROM investigations WHERE id='20251017_1151_deve-test-workflow'"
```
