# Experiment: 20251017_1220_deve-hello-french

## Quick Info

- **Type**: development
- **Scenario**: local-local
- **Created**: 2025-10-17 12:20:32
- **Researcher**: abhi
- **Status**: planned

## Purpose

Testing French greeting - Bonjour
...
just status 20251017_1220_deve-hello-french

# Fetch Tower metadata
just fetch-tower 20251017_1220_deve-hello-french

# Sync results
just sync-results 20251017_1220_deve-hello-french

# View in database
just query "SELECT * FROM experiments WHERE id='20251017_1220_deve-hello-french'"
```
